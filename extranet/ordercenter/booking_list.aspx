<%@ Page Language="C#" MasterPageFile="~/MasterPage_ExtranetControlPanel.master" Theme="hotels2theme" AutoEventWireup="true" CodeFile="booking_list.aspx.cs" Inherits="Hotels2thailand.UI.extranet_booking_booking_list" EnableEventValidation="false" EnableTheming="false"  %>
<asp:Content ID="Content2" ContentPlaceHolderID="head" Runat="Server">

  <script type="text/javascript" language="javascript" src="../../scripts/jquery-1.9.1.js?ver=001"></script>
 ...
 <script language="javascript" type="text/javascript" src="../../scripts/extranet/darkman_utility_extranet.js"></script>
   ...
   <script language="javascript" type="text/javascript">
       ...
       function GetPageDefault(Isrefresh) {
           ...
           $.get("../ajax/ajax_booking_list.aspx?bs=" + qBookingStatus + "&bps=" + qBookingProductStatus + GetQuerystringProductAndSupplierForBluehouseManage("append"), function (data) {
       ...
       function GetBookingListbody(bookingStatus, bookingProductStatus, listtype, order) {
               ...
               $.get("../ajax/ajax_booking_list_body.aspx?bs=" + bookingStatus + "&bps=" + bookingProductStatus + "&lTpye=" + listtype + "&order=" + order + GetQuerystringProductAndSupplierForBluehouseManage("append"), function (data) {
       ...
       function GetBookingListSum(bookingStatus, bookingProductStatus, listtype,order) {
           $.get("../ajax/ajax_booking_list_sum.aspx?bs=" + bookingStatus + "&bps=" + bookingProductStatus + "&lTpye=" + listtype + "&order=" + order + GetQuerystringProductAndSupplierForBluehouseManage("append"), function (data) {
       ...
       function getBookingPage(pagestart, SBookingProduct, SBooking, listtype, pageactive, order) {
           ...
           $.get("../ajax/ajax_booking_list_body.aspx?bs=" + SBooking + "&bps=" + SBookingProduct + "&lTpye=" + listtype + "&page=" + pagestart + "&order=" + order  + GetQuerystringProductAndSupplierForBluehouseManage("append"), function (data) {
               ...
               $("#Booking_list_" + SBookingProduct).fadeOut('fast', function () {
                   ...
                   $("#Booking_list_" + SBookingProduct).fadeIn('fast', function () {
                       ...
                       $('html, body').animate({ scrollTop: $("#Booking_list_" + SBookingProduct).offset().top  }, 500);
       ...
       function getStatusProductBar(bookingStatus, bookingProductStatus) {
           ...
           $.get("../ajax/ajax_booking_list_statusBar.aspx?bs=" + bookingStatus + "&bps=" + bookingProductStatus + GetQuerystringProductAndSupplierForBluehouseManage("append"), function (data) {
