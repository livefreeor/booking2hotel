<%@ Page Title="Hotels2thailand:Booking Acknowledge" Language="C#" MasterPageFile="~/MasterPage_ExtranetControlPanel.master" AutoEventWireup="true" CodeFile="booking_report_detail_condition.aspx.cs" Inherits="Hotels2thailand.UI.extranet_booking_report_detail_condition" %>
...
<script type="text/javascript" language="javascript">
        ...
        $("#btn_apply").click(function () {
            ...
            SetHiddenDate();
                        ...
                        $("#booking_stat_bar").fadeOut('fast', function () {
                            GetBookingReportConditionTable();
                        });
    ...
    function GetBookingReportConditionTable() {
        ...
        $.post("../ajax/ajax_report_booking_summary_condition_detail.aspx" + GetQuerystringProductAndSupplierForBluehouseManage("new"), post, function (data) {
    ...
    function GetBookingStatNormal_Pie() {
        ...
        var Chart_name = $("#hd_chart_name").val();
        ...
        var url = "../ajax/ajax_report_booking_summary_condition_pie_chart.aspx" + GetQuerystringProductAndSupplierForBluehouseManage("new");
        ...
        $.post(url, post, function (data) {
            ...
            if (data != "") {
                ...
                $("#container").fadeIn('fast', function () {
                    RenderStatGraph_Pie(data, Chart_name);
    ...
    function RenderStatGraph_Pie(result,chartname) {
        ...
        var options = {
            ...
            tooltip: {
                formatter: function () {
                    return '<b>' + this.point.name + '</b>: ' + this.point.y + ' <br/>' + this.point.x + ' ' + GetChartUnitName(chartname);
                }
            },
            title: {
                text: null
            ...
            plotOptions: {
                pie: {
                    ...
                    dataLabels: {
                        ...
                        formatter: function () {
                            return '<b>' + this.point.name + '</b>: ' + this.point.y + ' ' + GetChartUnitName(chartname);
                        }
                    },
                    showInLegend: true
                }
...
//result = "standard Room,1,refundable/20;nonRefund/20;Nonrefund (adult 2 pax)/20%Deluxe Room,1,refundable/25;nonRefund/10;Nonrefund (adult 2 pax)/5";
                ...
                if (datas.length > 0) {
                    ...
                    for (i = 0; i < datas.length; i++) {
                        ...
                        if (i == 0)
                            isSlic = true;
                        var room = datas[i].split('*')[0];
                        var roomVal = datas[i].split('*')[1];

                        var RoomconditionDetail = datas[i].split('*')[2].split('!');


                        var strConditionDetail = "";
                        for (c = 0; c < RoomconditionDetail.length; c++) {
                            strConditionDetail = strConditionDetail + "<label>  - " + RoomconditionDetail[c].split('/')[0] + " : "
                            + RoomconditionDetail[c].split('/')[1] + "</label><br />";
                        }


                        series.data.push({ name: room, y: parseInt(roomVal), x: strConditionDetail, sliced: isSlic });
                    }
                }
...
<div style="clear:both"></div>
<div id="main_chart" style=" height:400px;">
    
    <div id="container" style="width: 915px; height: 400px; margin: 0 auto; display:none; ">
