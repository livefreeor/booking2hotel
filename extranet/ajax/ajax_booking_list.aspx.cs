...
public partial class ajax_booking_list : System.Web.UI.Page
{
    ...
    public string BookingListBodyBlock(string strBookingStatus, string strBookingProductStatus, byte bytTypeList,  string headcolor = "")
    {
        ...
        try
        {
            ...
            result.Append("<div id=\"Booking_list_" + strBookingProductStatus + "\" style=\"width:100%\" ></div>");
            result.Append("<div id=\"Booking_sum_" + strBookingProductStatus + "\" style=\"width:100%\"></div>");
            result.Append("</div>");
        }
        catch (Exception ex)
        {
