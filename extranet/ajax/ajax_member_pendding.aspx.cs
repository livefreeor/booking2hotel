...
{
    public partial class ajax_member_pendding : Hotels2BasePageExtra_Ajax
    {
        ...
        public string BookingListGen(int MemberId, int intPageStart)
        {
            StringBuilder BookingListResult = new StringBuilder();

        
            BookingList cBookingList = new BookingList();
            IList<object> ListBookingProductList = cBookingList.GetBookingList_member_pedding(1,"date_submit", MemberId,this.CurrentProductActiveExtra);
           ...
           // decimal PriceTotal = 0;
            ...
            int Total = cBookingList.GetBookingList_member_pedding_count(MemberId,  this.CurrentProductActiveExtra);
