...
public partial class ajax_booking_payment_insertForm : System.Web.UI.Page
{
    ...
    public string getBookingPayMentInsert()
    {
        ...
        result.Append("<tr style=\"background-color:#ffffff; height:25px;\" ><td>&nbsp;Title</td><td>&nbsp;<input type=\"text\" id=\"payment_title\"  class=\"Extra_textbox_form\" value=\"staff\" style=\"width:150px;\" name=\"payment_title\" /></td></tr>");
        result.Append("<tr style=\"background-color:#ffffff; height:25px;\" ><td>&nbsp;Payment Cat</td><td>&nbsp;");
        result.Append("<select id=\"payment_cat\" name=\"payment_cat\" class=\"Extra_Drops_small_form\" >");
        ...
        //result.Append("</select>");
        //result.Append("</td></tr>");
        result.Append("<tr style=\"background-color:#ffffff; height:25px;\" ><td>&nbsp;Amount</td><td>&nbsp;<input type=\"text\" value=\"" + GrandRequestTotal() + "\" id=\"payment_amount\"  class=\"Extra_textbox_form\" style=\"width:80px;\" name=\"payment_amount\" /></td></tr>");
