...
{
    public partial class ajax_report_booking_compare_month : Hotels2BasePageExtra_Ajax
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            if (this.Page.IsPostBack)
            {
                if (!string.IsNullOrEmpty(Request.Form["sel_date_month_year"]) && !string.IsNullOrEmpty(Request.Form["hd_chart_name"]) && !string.IsNullOrEmpty(Request.Form["hd_compare_metric"]))
                {
