...
{
    public partial class admin_ajax_meal_period_detail : Hotels2BasePageExtra_Ajax
    {
        ...
        public string GetPeriodPrice()
        {
            ...
            ProductConditionExtra Topcondition = cConditionExtra.getTopConditionByOptionId(int.Parse(qOptionId));
            int intConditionId = Topcondition.ConditionId;
            ...
            IList<object> iListPeriod = cProductPricePeriod.getPricePackageListByConditionId(intConditionId);
            if (iListPeriod.Count() > 0)
            {

                strListItem = strListItem + "<div id=\"rate_load_head\"  >";
                strListItem = strListItem + "<table width=\"100%\" >";
                strListItem = strListItem + " <tr bgcolor=\"#96b4f3\" align=\"center\"><td width=\"15%\">Date From</td><td width=\"15%\">Date To</td>";
                strListItem = strListItem + "<td width=\"10%\">Amount</td>";
                strListItem = strListItem + "<td width=\"10%\">Surcharge</td><td width=\"20%\">Day Surcharge</td><td width=\"10%\">Holiday Surcharge</td><td width=\"5%\">Delete</td>";
                strListItem = strListItem + "</tr>";
                strListItem = strListItem + "</table>";
                strListItem = strListItem + "</div>";

                foreach (ProductPriceExtra_period priceperiod in iListPeriod)
                {
                    ...
                    strListItem = strListItem + "<td width=\"5%\"><img src=\"../../images_extra/bin.png\" onclick=\"delMeal('" + pricePeriodId + "');\" style=\"cursor:pointer;\"  /></td>";
                    strListItem = strListItem + "</tr>";
                    strListItem = strListItem + "</table>";
                    strListItem = strListItem + "</div>";
                }
            ...
            {
                strListItem = strListItem +"<div class=\"box_empty\">";
                //result.Append("");
                strListItem = strListItem +"<p><label>Sorry!</label> No Price for this meal</p>";
                //result.Append("");
                strListItem = strListItem + "</div>";
            }
            ...
            //result.Append("<div class=\"box_empty_package\">");
            //result.Append("");
