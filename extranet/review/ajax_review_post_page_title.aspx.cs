...
{
    public partial class admin_ajax_review_post_page_title : Hotels2BasePageExtra_Ajax
    {
        ...
        {
            int intListTotal = 0;
            intListTotal = ReviewManage.ReviewListTotal_HotelManage(ProductType(this.qreview), ReviewType(this.qreviewtype), this.CurrentProductActiveExtra);
