...
{
    public partial class admin_ajax_review_post :  Hotels2BasePageExtra_Ajax
    {
        ...
        public IList<object> PageResult()
        {
           ...
           //int totalPage = (int)Math.Ceiling((double)Total / PageSize);
            ...
            {
                obj = ReviewManage.GetReivewListHotelManage(false, ProductType(this.qreview), ReviewType(this.qreviewtype), true, IndexStart, _page_size, this.CurrentProductActiveExtra);
