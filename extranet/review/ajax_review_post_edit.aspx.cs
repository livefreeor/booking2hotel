        ...
        public string reviewResultFrom(string ProductCat, int intreviewId)
        {
            StringBuilder strResult = new StringBuilder();
                    ...
                    if (!string.IsNullOrEmpty(this.qreview) && !string.IsNullOrEmpty(this.qReviewId))
                    {
                        ...
                        strResult.Append("<input type=\"button\" value=\"Save\" class=\"btStyle\" onclick=\"RevieweditSave('" + reviews_item.ReviewId + "')\" />&nbsp;&nbsp;");
                        strResult.Append("<input type=\"button\" value=\"Cancel\" class=\"btStyleWhite\" onclick=\"RestoreTempReviewBlock('" + reviews_item.ReviewId + "')\" />");
