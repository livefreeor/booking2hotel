<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage_ExtranetControlPanel.master" AutoEventWireup="true" CodeFile="extra_bed.aspx.cs" Inherits="Hotels2thailand.UI.extranet_extra_bed" %>
...
<script type="text/javascript" language="javascript">
    ...
    function getExtrbedInserBox() {
        ...
        $.get("../ajax/ajax_extrabed_insertbox.aspx?opcat=39" + GetQuerystringProductAndSupplierForBluehouseManage("append"), function (data) {
            ...
            $("#btnInsertnewExtra").click(function () {
                ...
                if (valid == 0 && ValidateOptionMethod("extrabed_amount_rate", "number") == true) {
                    ...
                    $.post("../ajax/ajax_extrabed_save_insertbox.aspx" + GetQuerystringProductAndSupplierForBluehouseManage("new"), post, function (data) {
                        console.log(data);
                        if (data == "True") {
                            DarkmanPopUpAlert(450, "Extra bed rate is added completely. Thank you.");
                            DatepickerDual("extrabed_date_start", "extrabed_date_end");
                            getPeriodCurrentExtrabed();
                        }
...
<h4><asp:Image ID="Image4" runat="server" ImageUrl="~/images/content.png" /> Extra Bed Insert Box</h4>
