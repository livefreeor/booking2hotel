<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage_ExtranetControlPanel.master" AutoEventWireup="true" CodeFile="minimum_night.aspx.cs" Inherits="Hotels2thailand.UI.extranet_mimimum_night" %>
...
<script type="text/javascript"  language="javascript">
    ...
    function GetConditionList() {
        $("<td><img class=\"img_progress\" src=\"../../images_extra/preloader.gif\" alt=\"Progress\" /></td>").insertBefore("#condition_list").ajaxStart(function () {
            $(this).show();
        }).ajaxStop(function () {
            $(this).remove();
        });
        ...
        if (qOptionId != "") {
            qOptionId = GetValueQueryString("oid");
        }
        else {
        ...
        $.get("../ajax/ajax_condition_list_min_day.aspx?oid=" + qOptionId + GetQuerystringProductAndSupplierForBluehouseManage("append"), function (data) {
    ...
    function EditCondition(encodeConditionId) {
        ...
        if (GetValueQueryString("pid") == "" && GetValueQueryString("supid") == "") {
            window.location.href = "minimum_night_control.aspx?cdid=" + encodeConditionId + "&oid=" + OptionIdVal;
        }
        else {
            window.location.href = "minimum_night_control.aspx?pid=" + GetValueQueryString("pid") + "&supid=" + GetValueQueryString("supid") + "&cdid=" + encodeConditionId + "&oid=" + OptionIdVal;
        }
