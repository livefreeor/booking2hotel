<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage_ControlPanel.master" AutoEventWireup="true" CodeFile="account_bht_payment_history.aspx.cs" Inherits="Hotels2thailand.UI.admin_account_account_bht_payment_history" %>
    ...
    <div class="tbl_account_block">
        <%--<div>
            <asp:DropDownList ID="dropListType" runat="server">
                <asp:ListItem Value="0">เดือนปัจจุบัน</asp:ListItem>
                <asp:ListItem Value="0">เดือนปัจจุบัน</asp:ListItem>
                <asp:ListItem Value="0">เดือนปัจจุบัน</asp:ListItem>
                <asp:ListItem Value="0">เดือนปัจจุบัน</asp:ListItem> 
                <asp:ListItem Value="0">เดือนปัจจุบัน</asp:ListItem>
           ...
           <FooterStyle HorizontalAlign="Right" />
            <Columns>
                ...
                <asp:TemplateField HeaderText="Date Payment">
                     <ItemTemplate>
                             <asp:Label ID="lblDatePayment" runat="server" Text='<%# String.Format("{0:dd-MMM-yyyy HH:MM tt}",Eval("DatePayment"))  %>'></asp:Label>
                     </ItemTemplate>
                    <FooterTemplate>
                        
                    </FooterTemplate>
                </asp:TemplateField>
                <asp:TemplateField HeaderText="Account Name" ItemStyle-HorizontalAlign="Left">
                     <ItemTemplate>
                ...
                <asp:TemplateField HeaderText="Fee">
                     <ItemTemplate>
                        <%--  <asp:Label ID="lblFee" runat="server" Text='<%# Eval("Fee") %>' ></asp:Label>--%>
                         <asp:Label ID="lblFee" runat="server" Text='<%# String.Format("{0:#,##0.00}", Eval("Fee")) %>' ></asp:Label>
