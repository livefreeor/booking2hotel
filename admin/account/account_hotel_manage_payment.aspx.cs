...
{
    public partial class admin_account_hotel_manage_payment : Hotels2BasePage
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!this.Page.IsPostBack)
            {
                ...
                IList<object> iListPaybht = cPayment.getAccountPayment_hotel_manage_pendding();

                GvbhtBank.DataSource = iListPaybht;
                GvbhtBank.DataBind();
