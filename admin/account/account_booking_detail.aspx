<%@ Page Language="C#" MasterPageFile="~/MasterPage_ControlPanel.master"  AutoEventWireup="true" CodeFile="account_booking_detail.aspx.cs" Inherits="Hotels2thailand.UI.admin_booking_account_booking_detail" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="head" Runat="Server">
   ...
   <script language="javascript" type="text/javascript" src="../../scripts/extranet/darkman_utility_extranet.js"></script>
     ...
     <script type="text/javascript" language="javascript">
         ...
         function BookingConfirm(confirmCatId, bProductId) {

             var qBookingID = GetValueQueryString("bid");


             if (typeof bProductId == 'undefined') {
                 ...
                 $("<img class=\"img_progress\" src=\"../../images/progress.gif\" alt=\"Progress\" />").insertBefore("#booking_product_confirm_pan_" + bProductId).ajaxStart(function () {
                     $(this).show();
                 }).ajaxStop(function () {
                     $(this).remove();
                 });
                 $.get("../ajax/ajax_booking_confirm.aspx?bid=" + qBookingID + "&bpid=" + bProductId + "&conc=" + confirmCatId, function (data) {
                     if (data == "1") {
         ...
         function ConfirmSwitchBackBooking(confirmCatId, bProductId) {
             var qBookingID = GetValueQueryString("bid");
             ...
             if (typeof bProductId == 'undefined') {
                 ...
                 $.get("../ajax/ajax_booking_confirm_switchBack.aspx?bid=" + qBookingID + "&bpid=" + bProductId + "&conc=" + confirmCatId, function (data) {
