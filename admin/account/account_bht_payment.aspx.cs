...
{
    public partial class admin_account_account_bht_payment :Hotels2BasePage
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!this.Page.IsPostBack)
            {
                ...
                IList<object> iLisAcc = cBhtBank.getBhtBankAccountCurrentPayment();
        ...
        protected void GvBhtAccount_RowDataBound(object sender, GridViewRowEventArgs e)
        {
            if (e.Row.RowType == DataControlRowType.DataRow)
            {
                ...
                IList<object> iListPaybht = cPayment.getAccountPaymentBybhtAccountID(bytAccountId);
