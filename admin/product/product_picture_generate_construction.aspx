<%@ Page Language="C#" MasterPageFile="~/MasterPage_ControlPanel.master" AutoEventWireup="true" CodeFile="product_picture_generate_construction.aspx.cs" Inherits="Hotels2thailand.UI.admin_product_picture_generate_construction" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="head" Runat="Server">
   ...
   <script type="text/javascript" src="../../Scripts/jquery-1.4.2.js"></script>
    ...
    <style type="text/css">
     ...
     .mainItem_Title{margin:10px 0px 0px 0px; padding:0px;font-weight:bold; font-size:14px;}
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <p  class="gHead">Option Picture Generate Source  <asp:Button ID="GenPic" runat="server" Text="RENAME & GENERATE NOW!!" OnClick="GenPic_ONclick"  SkinID="Green"   Width="250px" Height="35px" Font-Size="14px" /></p>
    

    <asp:Label ID="OptionPic" runat="server"></asp:Label>
