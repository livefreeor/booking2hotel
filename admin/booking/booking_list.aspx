<%@ Page Language="C#" MasterPageFile="~/MasterPage_ControlPanel.master" Theme="hotels2theme" AutoEventWireup="true" CodeFile="booking_list.aspx.cs" Inherits="Hotels2thailand.UI.admin_booking_booking_list" EnableEventValidation="false" EnableTheming="false" EnableViewState="false" %>
 ...
 <script language="javascript" type="text/javascript" src="../../scripts/extranet/darkman_utility_extranet.js"></script>
   ...
   <script language="javascript" type="text/javascript">
       ...
       function GetBookingListbody(bookingStatus, bookingProductStatus, listtype, order) {
           ...
           $.get("../ajax/ajax_booking_list_body.aspx?bs=" + bookingStatus + "&bps=" + bookingProductStatus + "&lTpye=" + listtype + "&order=" + order + "&dis=no", function (data) {
       ...
       function GetBookingListSum(bookingStatus, bookingProductStatus, listtype, order) {
           $.get("../ajax/ajax_booking_list_sum.aspx?bs=" + bookingStatus + "&bps=" + bookingProductStatus + "&lTpye=" + listtype + "&order=" + order + "&dis=no", function (data) {
       ...
       function getBookingPage(pagestart, SBookingProduct, SBooking, listtype, pageactive, order) {
           ...
           $.get("../ajax/ajax_booking_list_body.aspx?bs=" + SBooking + "&bps=" + SBookingProduct + "&lTpye=" + listtype + "&page=" + pagestart + "&order=" + order + "&dis=no", function (data) {
