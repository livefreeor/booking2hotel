...
{
    public partial class admin_review_send : Hotels2BasePage
    {
        //booking_id
        ...
        public void submit_click(object sender, EventArgs e)
        {
            ...
            if (Issent)
            {
                ...
                ScriptManager.RegisterStartupScript(this, Page.GetType(), null, "<script>DarkmanPopUpComfirm('450','Mail was sent successfully.<br/> would like to close this window now !?','window.close();if (window.opener && !window.opener.closed) {window.opener.location.reload();}');</script>", false);
