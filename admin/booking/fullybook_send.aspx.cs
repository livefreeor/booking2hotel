...
{
    public partial class admin_fullybook_send : Hotels2BasePage
    {
        //booking_id
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!Page.IsPostBack)
            {
                ...
                editor.Content = cMailBooking.getMailFullyBook();

                txtMailTO.Text = cMailBooking.GetEmailBooking();
                txtBcc.Text = "sent@hotels2thailand.com;sent2@hotels2thailand.com";
                txtSubject.Text = "Reservation from hotels2thailand.com (ORDER ID:" + this.strBookingId + ") FULLY BOOKED.";
