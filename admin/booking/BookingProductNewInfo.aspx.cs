...
public partial class admin_booking_BookingProductNewInfo : System.Web.UI.Page
{
    protected void Page_Load(object sender, EventArgs e)
    {
        if (!Page.IsPostBack)
        {
            ...
            //DateTime dateStart = new DateTime(2010, 8, 20);
            //DateTime dateEnd = dateStart.AddDays(4);
            ...
            for (int conditionCount = 0; conditionCount < conditionID.Count(); conditionCount++)
            {
                ...
                {
                    //price = new CalculatePrice(condetionID[conditionCount], dateStart, dateEnd);
                    //Response.Write((priceProduct.CalculateAll(conditionID[conditionCount], optionID[conditionCount]).Price));
                    ...
                    //formDisplay = formDisplay + "<strong>" + productID[productCount] + "--" + quantity[productCount] + "</strong><br>";
                }
            ...
            //HttpContext.Current.Response.Write(ExtraOptionList.Count());
            ...
            RequireInfo = RequireInfo + "<input type=\"hidden\" name=\"booking_id\" value=\"" + Request.Form["booking_id"] + "\">\n";
            ...
            RequireInfo = RequireInfo + "<input type=\"hidden\" name=\"adult\" value=\"" + Request.Form["adult"] + "\">\n";
            RequireInfo = RequireInfo + "<input type=\"hidden\" name=\"child\" value=\"" + Request.Form["child"] + "\">\n";
