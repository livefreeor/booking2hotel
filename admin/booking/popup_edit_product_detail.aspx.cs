...
{
    public partial class extranet_ordercenter_popup_edit_product_detail : Hotels2BasePage
    {
        ...
        public void GVitemList_OnRowDataBound(object sender, GridViewRowEventArgs e)
        {
            if (e.Row.RowType == DataControlRowType.DataRow)
            {
                ...
                TextBox txtPrice = e.Row.Cells[4].FindControl("GvtxtPrice") as TextBox;
                TextBox txtPriceSup = e.Row.Cells[5].FindControl("GvtxtPriceSup") as TextBox;
                ...
                decimal PriceSup = (decimal)DataBinder.Eval(e.Row.DataItem, "PriceSupplier");
                ...
                txtPriceSup.Text = PriceSup.Hotels2Currency();
        ...
        public void mainSave_Onclick(object sender, EventArgs e)
        {
            ...
            foreach (GridViewRow GvRow in GVitemList.Rows)
            {
                if (GvRow.RowType == DataControlRowType.DataRow)
                {
                    ...
                    TextBox txtPriceSup = GVitemList.Rows[GvRow.RowIndex].Cells[2].FindControl("GvtxtPriceSup") as TextBox;
                    ...
                    cBookingItemDis.UpdateBookingItem(intBookingItemId, decimal.Parse(txtPrice.Text), decimal.Parse(txtPriceSup.Text), byte.Parse(GvdropQuantity.SelectedValue), true);
                }
