...
public partial class ajax_booking_product_list : System.Web.UI.Page
{
    ...
    public string getBookingProductList()
    {
        ...
        foreach (BookingProductList pItem in cBookingProduct.getProductListShowFirstByBookingId(int.Parse(this.qBookingId)))
        {
            ...
            result.Append("<a href=\"javascript:popup('changeProduct.aspx?bid=" + this.qBookingId + "&bpid=" + pItem.BookingProductId + "&proid=" + pItem.ProductID + "&cid=" + pItem.ProductCategory + "',700,850)\">Add New Product</a> ");
            result.Append("<a href=\"javascript:popup('changePeriod.aspx?bid=" + this.qBookingId + "&bpid=" + pItem.BookingProductId + "&proid=" + pItem.ProductID + "&cid=" + pItem.ProductCategory + "',700,850)\">Change period</a> ");
            result.Append("<a href=\"javascript:popup('BookingAddNewItem.aspx?bid=" + this.qBookingId + "&bpid=" + pItem.BookingProductId + "',700,850)\">Add New Item</a> ");
            result.Append("</p>");
