...
public partial class ajax_booking_list_sum : System.Web.UI.Page
{
        ...
        public string BookingSum(string strBookingStatus, string strBookingProductStatus, string BookingListType)
    {
        ...
        try
        {
            ...
            if (!string.IsNullOrEmpty(this.qBookingTypeB2b))
            {
                if (this.qBookingTypeB2b == "b2b")
                {
                    ...
                    {
                        case 1:
                            Total = cBookingList.GetBookingListOrderCenter_Count_bhtManage_B2b(shrBookingStatus, shrBookingProductStatus);
                            arrPrice = cBookingList.GetBookingListOrderCenter_SumPrice_bhtMange_B2b(shrBookingStatus, shrBookingProductStatus);
                            break;
                        case 2:
                ...
                else
                {
                    ...
                    {
                        case 1:
                            Total = cBookingList.GetBookingListOrderCenter_Count_bhtManage(shrBookingStatus, shrBookingProductStatus);
                            arrPrice = cBookingList.GetBookingListOrderCenter_SumPrice_bhtMange(shrBookingStatus, shrBookingProductStatus);
            ...
            result.Append("<tr style=\"background-color:#faffbd;\">");
            result.Append("<td width=\"60%\" style=\"text-align:left;\"><p class=\"bookingList_Page\">" + getPageList(Total, strBookingStatus, strBookingProductStatus, BookingListType) + "</p></td>");
        ...
        public string getPageList(int Total, string strStatusbooking, string strStatusbookingProduct, string BookingListType)
        {
