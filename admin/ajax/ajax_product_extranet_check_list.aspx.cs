...
{
    public partial class ajax_product_extranet_check_list : System.Web.UI.Page
    {
        ...
        public string SupplierAndProductExtranetList()
        {
            ...
            IList<object> iProductList = cProductList.getProductListProcedure(29, 0, 0, true);
            ...
            result.Append("<th width=\"35%\">Hotel Name</th><th width=\"10%\">Manage</th><th width=\"5%\">1.</th><th width=\"5%\">2.</th><th width=\"5%\">3.</th><th width=\"5%\">4.</th><th width=\"5%\">5.</th></tr>");
            ...
            foreach (ProductListAdmin product in iProductList)
            {
                ...
                string UrlProductManage = "/admin/product/product.aspx?pid=" + product.ProductId + "&pdcid=29";
