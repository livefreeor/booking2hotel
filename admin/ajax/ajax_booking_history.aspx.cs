...
public partial class ajax_booking_history : System.Web.UI.Page
{
    ...
    public string BookingListGen(string strEmail, string strNameFull, int intBookingId)
    {
        ...
        IList<object> ListBookingProductList = cBookingList.GetBookingListHistory_BHTmange(intBookingId, strEmail, strNameFull, 1, 1, "date_submit");
        ...
        foreach (BookingList BpItem in ListBookingProductList)
        {
            ...
            BookingListResult.Append("<td><a href=\"booking_detail.aspx?bid=" + BpItem.BookingID + "\" target=\"_blank\">" + BpItem.BookingHotelID + "/" + BpItem.BookingID + "</a></td>\r\n");
        ...
        int Total = cBookingList.GetBookingListHistory_Count_BHTmange(intBookingId, strEmail, strNameFull, 1, 1, "date_submit");
