...
public partial class ajax_booking_payment_EditForm : System.Web.UI.Page
{
    ...
    public string getBookingPayMentInsert()
    {
        ...
        result.Append("<tr style=\"background-color:#ffffff; height:25px;\" ><td>&nbsp;Title</td><td>&nbsp;<input type=\"text\" id=\"payment_title\"  class=\"TextBox_Extra_normal_small\" value=\"" + cPaymentDisplay.Title + "\" style=\"width:150px;\" name=\"payment_title\" /></td></tr>");
        ...
        if (cPaymentDisplay.ConfirmPayment.HasValue)
            result.Append("<select id=\"payment_cat\" name=\"payment_cat\" class=\"DropDownStyleCustom\"  disabled=\"disabled\" >");
        else
        ...
        if (cPaymentDisplay.ConfirmPayment.HasValue)
            result.Append("<select id=\"payment_gateway\" name=\"payment_gateway\"  class=\"DropDownStyleCustom\" disabled=\"disabled\" >");
        else
        ...
        result.Append("<tr style=\"background-color:#ffffff; height:25px;\" ><td>&nbsp;Amount</td><td>&nbsp;<input type=\"text\" id=\"payment_amount\" value=\"" + cPaymentDisplay.Amount.Hotels2Currency() + "\" class=\"TextBox_Extra_normal_small\" style=\"width:80px;\" name=\"payment_amount\" /></td></tr>");
