...
{
    public partial class admin_ajax_review_post_navigator : System.Web.UI.Page
    {
        ...
        public int PageTotal()
        {
            int ListTotal = 0;
            int intPageTotal = 0;
            ListTotal = ReviewManage.ReviewListTotal_BHTmanage(ProductType(this.qreview), ReviewType(this.qreviewtype));
