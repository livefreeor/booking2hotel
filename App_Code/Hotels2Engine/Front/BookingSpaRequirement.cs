...
/// <summary>
/// Summary description for BookingSpaRequirement
/// </summary>
public class BookingSpaRequirement : Hotels2BaseClass
{
    public int RequireID { get; set; }
    public int BookingItemID { get; set; }
    public string Comment { get; set; }

    public BookingSpaRequirement(int bookingItemID, string comment)
	{
        BookingItemID = bookingItemID;
        Comment = comment;
	}
    public int Insert(BookingSpaRequirement data)
    {
        int ret = 0;
