...
/// <summary>
/// Summary description for FrontPromotion
/// </summary>
/// 
namespace Hotels2thailand.Front
{
    public class FrontPromotion
    {
        ...
        public FrontPromotion GetPromotionByID(int promotionID)
        {
            ...
            sqlCommand = sqlCommand + " pm.date_end,pm.date_use_start,pm.date_use_end,pm.time_start,pm.time_end,pm.quantity_min,pm.day_min,pm.day_advance_num,pm.date_submit,pm.day_mon,pm.day_tue,pm.day_wed,";
            sqlCommand = sqlCommand+" pm.day_thu,pm.day_fri,pm.day_sat,pm.day_sun,pm.is_weekend_all,pm.is_holiday_charge,pm.max_set,pm.is_breakfast,pm.breakfast_charge,pm.status,pm.comment"; 
            sqlCommand = sqlCommand+" from tbl_promotion pm,tbl_promotion_content pmc where pm.promotion_id=pmc.promotion_id and pmc.lang_id=1 and pm.promotion_id="+promotionID;
            ...
            if (reader.Read()) {
                ...
                this.DateUseStart = (DateTime)reader["date_use_start"];
                this.DateUseEnd = (DateTime)reader["date_use_end"];
        ...
        public FrontPromotion GetPromotionExtraByID(int promotionID)
        {
            string sqlCommand = "select top 1  pm.promotion_id,pm.cat_id,pm.product_id,pm.supplier_id,pm.title,pmc.title as title_lang,pmc.detail,pm.date_start,";
            sqlCommand = sqlCommand + " pm.date_end,pm.date_use_start,pm.date_use_end,pm.time_start,pm.time_end,pm.quantity_min,pm.day_min,pm.day_advance_num,pm.date_submit,pm.day_mon,pm.day_tue,pm.day_wed,";
            sqlCommand = sqlCommand + " pm.day_thu,pm.day_fri,pm.day_sat,pm.day_sun,pm.is_weekend_all,pm.is_holiday_charge,pm.max_set,pm.is_breakfast,pm.breakfast_charge,pm.status,pm.comment";
