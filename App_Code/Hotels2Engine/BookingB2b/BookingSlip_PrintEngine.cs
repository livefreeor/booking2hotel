...
{
    public partial class BookingSlip_PrintEngineB2b :  BookingPrintAndVoucher_Helper
    {
        public int BookingProductId { get; set; }

        public BookingSlip_PrintEngineB2b(int intBookingProductId)
        {
        ...
        {
            StreamReader objReader = new StreamReader(HttpContext.Current.Server.MapPath("/admin/booking/BookingPrintAndMail_Template_B2b/Template_SlipPrint.html"));
        ...
        public string getSlip()
        {
           ...
           // string PhoneFax_ResAndSales = SupContact.GetstringContact(cBookingPLsit.SupplierId, "3,1", "3");
            ...
            {
                case 29:
                    StreamReader objHotelDetailReader = new StreamReader(HttpContext.Current.Server.MapPath("/admin/booking/BookingPrintAndMail_Template_B2b/tbookingPrint_Slip_Bookingdetail_hotel.html"));
                ...
                case 32:
                    ...
                    StreamReader objHotelDetailReaderGolf = new StreamReader(HttpContext.Current.Server.MapPath("/admin/booking/BookingPrintAndMail_Template_B2b/tbookingPrint_Slip_Bookingdetail_golf.html"));
                ...
                case 40:
                    ...
                    StreamReader objHotelDetailReader_Spa = new StreamReader(HttpContext.Current.Server.MapPath("/admin/booking/BookingPrintAndMail_Template_B2b/tbookingPrint_Slip_Bookingdetail_spa.html"));
                ...
                case 31:
                    ...
                    StreamReader objHotelDetailReader_transfer = new StreamReader(HttpContext.Current.Server.MapPath("/admin/booking/BookingPrintAndMail_Template_B2b/tbookingPrint_Slip_Bookingdetail_transfer.html"));
                ...
                case 38:
                    ...
                    StreamReader objHotelDetailReader_Show_water_Daytrip = new StreamReader(HttpContext.Current.Server.MapPath("/admin/booking/BookingPrintAndMail_Template_B2b/tbookingPrint_Slip_Bookingdetail_day_water_show.html"));
                ...
                case 39:
                    ...
                    StreamReader objHotelDetailReader_Health = new StreamReader(HttpContext.Current.Server.MapPath("/admin/booking/BookingPrintAndMail_Template_B2b/tbookingPrint_Slip_Bookingdetail_transfer.html"));
