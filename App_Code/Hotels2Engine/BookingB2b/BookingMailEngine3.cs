...
namespace Hotels2thailand.BookingB2b
{
    public partial class BookingMailEngineB2b : BookingPrintAndVoucher_Helper
    {
        ...
        protected string getStarPicColor(byte bytStarClass)
        {
            ...
            {
                result = result + "<td style=\"margin:0px;padding:0px;\" align=\"left\"><img src=\"http://www.hotels2thailand.com/images_mail/star2.jpg\" alt=\"\" width=\"15\" height=\"19\" /></td>";
            }
        ...
        protected string getStarPic(byte bytStarClass)
        {
            ...
            for (int i = 0; i < bytStarClass; i++)
            {
                result = result + "<td style=\"margin:0px;padding:0px;\" align=\"left\"><img src=\"http://www.hotels2thailand.com/images_mail/star1.jpg\" alt=\"\" width=\"15\" height=\"19\" /></td>";
            }
