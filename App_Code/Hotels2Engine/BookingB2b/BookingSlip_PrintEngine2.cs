...
{
    public partial class BookingSlip_PrintEngineB2b
    {
        ...
        private string GetAccountlist(short shrSupplierId)
        {
            ...
            result.Append("<table style=\"width:100%;background-color:#000000; font-size:12px;font-family:tahoma\" cellpadding=\"0\" cellspacing=\"1\"  >");
