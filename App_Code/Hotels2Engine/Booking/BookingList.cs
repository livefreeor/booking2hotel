...
{
    public class BookingList : Hotels2BaseClass
    {
       ...
       // public decimal Settle { get; set; }
        ...
        public List<object> GetBookingListOrderCenter_bhtManage(short bookingStatus, short bookingProductStatus, byte queryType, int PageActive, string OrderBy)
        {
            ...
            using (SqlConnection cn = new SqlConnection(this.ConnectionString))
            {
                SqlCommand cmd = new SqlCommand("bk_order_booking_list_normalList_bhtmanage", cn);
                cmd.CommandType = CommandType.StoredProcedure;
                cmd.Parameters.Add("@StartRowIndex", SqlDbType.Int).Value = PageActive;
                cmd.Parameters.Add("@queryType", SqlDbType.TinyInt).Value = queryType;
                cmd.Parameters.Add("@b_status_id", SqlDbType.SmallInt).Value = bookingStatus;
        ...
        public List<object> GetBookingListOrderCenter_bhtManage_B2b(short bookingStatus, short bookingProductStatus, byte queryType, int PageActive, string OrderBy)
        {

            using (SqlConnection cn = new SqlConnection(this.ConnectionString))
            {
                SqlCommand cmd = new SqlCommand("bk_order_booking_list_normalList_bhtmanage_B2b", cn);
                cmd.CommandType = CommandType.StoredProcedure;
                cmd.Parameters.Add("@StartRowIndex", SqlDbType.Int).Value = PageActive;
                cmd.Parameters.Add("@queryType", SqlDbType.TinyInt).Value = queryType;
                cmd.Parameters.Add("@b_status_id", SqlDbType.SmallInt).Value = bookingStatus;
        ...
        public int GetBookingListOrderCenter_Count_bhtManage_B2b(short bookingStatus, short bookingProductStatus)
        {
            using (SqlConnection cn = new SqlConnection(this.ConnectionString))
            {
                SqlCommand cmd = new SqlCommand("bk_order_booking_list_normalList_bhtmanage_B2b", cn);
        ...
        public List<object> GetBookingListOrderCenterDuplicate_B2b(short bookingStatus, short bookingProductStatus, byte queryType, int PageActive, string OrderBy)
        {
            using (SqlConnection cn = new SqlConnection(this.ConnectionString))
            {
                SqlCommand cmd = new SqlCommand("bk_order_booking_list_duplicate_booking", cn);
        ...
        public ArrayList GetBookingListOrderCenter_SumPrice_bhtMange(short bookingStatus, short bookingProductStatus)
        {
            ...
            {
                ArrayList arrPriceSum = new ArrayList();
                SqlCommand cmd = new SqlCommand("bk_order_booking_list_normalList_bhtmanage", cn);//bk_order_booking_list_normalList_bhtmanage_B2b
                cmd.CommandType = CommandType.StoredProcedure;
                cmd.Parameters.Add("@StartRowIndex", SqlDbType.Int).Value = 0;
                cmd.Parameters.Add("@queryType", SqlDbType.TinyInt).Value = 3;
                cmd.Parameters.Add("@b_status_id", SqlDbType.SmallInt).Value = bookingStatus;
        ...
        public ArrayList GetBookingListOrderCenter_SumPrice_bhtMange_B2b(short bookingStatus, short bookingProductStatus)
        {

            using (SqlConnection cn = new SqlConnection(this.ConnectionString))
            {
                ArrayList arrPriceSum = new ArrayList();
                SqlCommand cmd = new SqlCommand("bk_order_booking_list_normalList_bhtmanage_B2b", cn);//bk_order_booking_list_normalList_bhtmanage_B2b
                cmd.CommandType = CommandType.StoredProcedure;
                cmd.Parameters.Add("@StartRowIndex", SqlDbType.Int).Value = 0;
                cmd.Parameters.Add("@queryType", SqlDbType.TinyInt).Value = 3;
                cmd.Parameters.Add("@b_status_id", SqlDbType.SmallInt).Value = bookingStatus;
        ...
        public List<object> GetBookingList_Status_OrderOpen_B2b(short bookingStatus, short bookingProductStatus, byte queryType, int PageActive, string OrderBy)
        {
            using (SqlConnection cn = new SqlConnection(this.ConnectionString))
            {
                SqlCommand cmd = new SqlCommand("bk_order_booking_list_openorder", cn);
        ...
        public List<object> GetBookingList_Status_CheckinDueDate_B2b(short bookingStatus, short bookingProductStatus, byte queryType, int PageActive, int intdueDate, string OrderBy)
        {
            using (SqlConnection cn = new SqlConnection(this.ConnectionString))
            {
                SqlCommand cmd = new SqlCommand("bk_order_booking_list_booknow_due_date", cn);
