...
{
    public partial class BookingBooking_PrintEngine : BookingPrintAndVoucher_Helper
    {
        public int BookingProductId { get; set; }

        public BookingBooking_PrintEngine(int intBookingProductId)
        {
        ...
        private string GetRequirement(int intBookingProductId, byte productCat)
        {
            ...
            {
                ReqItemResult.Append("<table width=\"100%\" border=\"0\" cellpadding=\"2\" cellspacing=\"2\" bgcolor=\"#444444\" class=\"m1\">");
                ...
                foreach (ArrayList items in cBookingItemRequireList)
                {
                    ...
                    ReqItemResult.Append("<table width=\"100%\" border=\"0\" cellpadding=\"2\" cellspacing=\"2\" bgcolor=\"#CCCCCC\">");
                    ReqItemResult.Append("<tr>");
                    ...
                    switch (productCat)
                    {
                        case 29:
                            ...
                            ReqItemResult.Append("</tr>");
                            ReqItemResult.Append("<tr>");
                            ReqItemResult.Append("<td align=\"left\" bgcolor=\"#FFFFFF\" class=\"mStrong\">Special Request </td>");
