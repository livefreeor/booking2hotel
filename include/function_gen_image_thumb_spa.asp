<%
FUNCTION function_gen_image_thumb_spa(intProductID,strProductCode,intNumImage,intType)
		...
		Case 1
			...
			For intCount=1 To 12
				...
				IF intCount<=intNumImage Then
					arrImage(intCount) = "<a href=""/thailand-spa-pic.asp?pic="& intCount &"&id="& intProductID &""" target=""_new""><img src=""/thailand-spa-pic/"& strProductCode & "_b_" & intCount &".jpg"" border=""0""></a>"
					intImage = intImage + 1
				Else
					arrImage(intCount) = "&nbsp;"
				End IF
...
<%
		Case 2
			...
			For intCount=1 To 32
				...
				IF intCount<=intNumImage Then
					arrImage(intCount) = "<a href=""/thailand-spa-pic.asp?pic="& intCount &"&id="& intProductID &"""><img src=""/thailand-spa-pic/"& strProductCode & "_b_" & intCount &".jpg"" border=""0""></a>"
					intImage = intImage + 1
				Else
					arrImage(intCount) = "&nbsp;"
				End IF
...
<%
		Case 3 'Option Pictures (12->3*4)
			...
			For intCount=1 To 12
				...
				IF intCount<=intNumImage Then
					arrImage(intCount) = "<a href=""/thailand-hotels-option-pic.asp?pic="& intCount &"&id="& intProductID &"""><img src=""/thailand-spa-pic/"& strProductCode & "_" & intProductID & "_b_" & intCount &".jpg"" border=""0""></a>"
					intImage = intImage + 1
				Else
					arrImage(intCount) = "&nbsp;"
				End IF
