	...
	SELECT CASE intdisplayType	
		Case 1
			...
			recCurrency.Open sqlCurrency, Conn,adOpenStatic, adLockReadOnly
				...
				Wend
				function_currency_list = function_currency_list & "</tr>" &vbcrlf
				function_currency_list = function_currency_list & "<tr><td colspan=""20"" align=""center"" class=""s""><br />This is the approximate rate in your preferred currency.You will have to pay us in the local currency (Thai Baht). </td></tr>" & VbCrlf 'For warning
