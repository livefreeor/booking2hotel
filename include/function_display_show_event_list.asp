<%
FUNCTION function_display_show_event_list(intProductID,intProductCatID,intDestinationID,strTitle,strDetail,strfilesName,strProductCode,intNumber,intType)
	...
	strReturn = strReturn & "<a class=nu href=""/"&function_generate_show_event_link(intDestinationID,"",1)&"/"&strFilesname&"""><font color=#003366><b><font color=""#ff6600"">"&strTitle&"</font></b></font></a> </div>" & VbCrlf
	...
	strReturn = strReturn & "<tr>" & VbCrlf
	strReturn = strReturn & "<td valign=""top""><a href=""/"&function_generate_show_event_link(intDestinationID,"",1)&"/"&strFilesname&"""><img src=""thailand-show-event-pic/"&strProductCode&"_1.jpg"" alt="""&strTitle&""" border=""0""></a></td>" & VbCrlf
	strReturn = strReturn & "</tr>" & VbCrlf
	...
	if fso.FileExists (server.mappath("thailand-show-event-pic/"&strProductCode&"_logo.gif")) then 
	strReturn = strReturn & "<a href=""/"&function_generate_show_event_link(intDestinationID,"",1)&"/"&strFilesname&"""><img src=""thailand-show-event-pic/"&strProductCode&"_logo.gif"" alt="""&strTitle&""" border=""0""></a><br><br>" & VbCrlf
	end if

	strReturn = strReturn & function_display_hotel_detail(strDetail,"",1) & VbCrlf
	strReturn = strReturn & "<br><br>" & VbCrlf
	strReturn = strReturn & "<a href=""/"&function_generate_show_event_link(intDestinationID,"",1)&"/"&strFilesname&"""><img src=""/images/b_book_now.gif"" border=""0""></a>" & VbCrlf
	strReturn = strReturn & "</td>" & VbCrlf
	strReturn = strReturn & "</tr>" & VbCrlf
	strReturn = strReturn & "<tr>" & VbCrlf
	...
	function_display_show_event_list = strReturn
