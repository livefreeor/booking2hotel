<%
FUNCTION function_gen_send_order_link(intOrderID,intProductcatID,intOrderProductID,intOrderItemID,intType)
	...
	'IF int(intOrderID)>=57988 Then
		SELECT CASE int(intProductCatID)
			Case 29 'Hotel
				SELECT CASE intType
					Case 1 'Booking
						strFile = "/dual/mail_booking_hotel.asp?id=" & intOrderProductID
			...
			Case 31 'Airport Transfer
				SELECT CASE intType
					Case 1 'Booking
						strFile = "/dual/mail_booking_trans.asp?id=" & intOrderProductID
					Case 2 'Voucher For Supplier
			...
			Case 32 'Golf Courses
				SELECT CASE intType
					Case 1 'Booking
						strFile = "/dual/mail_booking_golf.asp?id=" & intOrderProductID
					Case 2 'Voucher For Supplier
			...
			Case 34 'Sightseeing
				SELECT CASE intType
					Case 1 'Booking
						strFile = "/dual/mail_booking_sight.asp?id=" & intOrderProductID
					Case 2 'Voucher For Supplier
			...
			Case 36 'Water Activity
				SELECT CASE intType
					Case 1 'Booking
						strFile = "/dual/mail_booking_water_activity.asp?id=" & intOrderProductID
					Case 2 'Voucher For Supplier
			...
			Case 38 'Show
				SELECT CASE intType
					Case 1 'Booking
						strFile = "/dual/mail_booking_show_event.asp?id=" & intOrderProductID
					Case 2 'Voucher For Supplier
			...
			Case 39 'Health Check Up
				SELECT CASE intType
					Case 1 'Booking
						strFile = "/dual/mail_booking_health_check_up.asp?id=" & intOrderProductID
					Case 2 'Voucher For Supplier
			...
			Case 40 'Spa
				SELECT CASE intType
					Case 1 'Booking
						strFile = "/dual/mail_booking_spa.asp?id=" & intOrderProductID
					Case 2 'Voucher For Supplier
	...
	function_gen_send_order_link = strFile
