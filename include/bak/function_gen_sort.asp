<%
FUNCTION function_gen_sort(strCurrent,strURL,intType)
	...
	SELECT CASE intType
		Case 1
			...
			function_gen_sort = function_gen_sort & "<table width=""100%"" cellpadding=""0""  cellspacing=""1"" bgcolor=""#FFFFFF"">" & VbCrlf
			function_gen_sort = function_gen_sort & "<form action=""redirect.asp"" method=""get"">" & VbCrlf
			function_gen_sort = function_gen_sort & "<tr>" & VbCrlf
			function_gen_sort = function_gen_sort & "<td rowspan=""2"" bgcolor=""#EDF5FE"">"& strFeatureDESC &"</td>" & VbCrlf
			function_gen_sort = function_gen_sort & "<td bgcolor=""#EDF5FE"">"& strPriceASC &"</td>" & VbCrlf
			function_gen_sort = function_gen_sort & "<td bgcolor=""#EDF5FE"">"& strNameASC &"</td>" & VbCrlf
			function_gen_sort = function_gen_sort & "<td bgcolor=""#EDF5FE"">"& strClassASC &"</td>" & VbCrlf
			function_gen_sort = function_gen_sort & "<td rowspan=""2"" bgcolor=""#EDF5FE""><div align=""center""><input type=""image"" src=""/images/b_go.gif""></div></td>" & VbCrlf
			function_gen_sort = function_gen_sort & "</tr>" & VbCrlf
			function_gen_sort = function_gen_sort & "<tr>" & VbCrlf
			function_gen_sort = function_gen_sort & "<td bgcolor=""#EDF5FE"">"& strPriceDESC &"</td>" & VbCrlf
			function_gen_sort = function_gen_sort & "<td bgcolor=""#EDF5FE"">"& strNameDESC &"</td>" & VbCrlf
			function_gen_sort = function_gen_sort & "<td bgcolor=""#EDF5FE"">"& strClassDESC &"</td>" & VbCrlf
			function_gen_sort = function_gen_sort & "</tr>" & VbCrlf
			function_gen_sort = function_gen_sort & "</form>" & VbCrlf
			function_gen_sort = function_gen_sort & "</table>" & VbCrlf
