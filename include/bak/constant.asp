...
'######## NEW DATABASE AFFILIATE ##########
strConnAff = "Provider=MSDASQL; Driver={SQL Server}; Server=74.86.253.60; Database=hotels2thailandXXX; UID=ht2thXXX; PWD=gfnvo]tihvp]hko;"
'####################
...
strConnRW = "Provider=MSDASQL; Driver={SQL Server}; Server=74.86.253.60; Database=hotels2; UID=hotels2thailandwrite; PWD=kfoutdk$or3$;"
