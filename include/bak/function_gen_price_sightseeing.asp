...
FUNCTION function_gen_price_sightseeing(dateCheckIn,intOptionID,intAdult,intChild,intType)
	...
	sqlRateSight = sqlRateSight & " (SELECT TOP 1 sopq.supplement FROM tbl_option_price_quantity sopq WHERE sopq.price_id=op.price_id AND (quantity_min<"&intAdult&" AND quantity_max>="&intAdult&") ORDER BY quantity_max DESC) AS supplement"
