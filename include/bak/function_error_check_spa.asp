<%
FUNCTION function_error_check_spa()
	...
	'### SET REDIRECT PATH ###
	strRedirectPath = "/"& function_generate_spa_link(arrProduct(2,0),"",1)& "/"& arrProduct(3,0) & "?" & strQuery
	'### SET REDIRECT PATH ###	
	'### Check Outing ###
...
'	End IF
	...
	function_error_check_spa = strAllOption
