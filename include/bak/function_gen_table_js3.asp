<%
Function 	function_gen_table_js3(arrList,arrCol,bodyColor,bgColor,txtTitle,txtColor,pColor,intType,strCate,intSort,arrList2,arrList3,psid,dest_id,curr,arrRate)
	Dim BCon
	Dim HBCon
	Dim HCCon
	Dim LCCon
