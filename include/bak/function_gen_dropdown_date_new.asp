<%
FUNCTION function_gen_dropdown_date_new(intDay,intMonth,intYear,strDayName,strMonthName,strYearName,intType)
	...
	SELECT CASE intType
		...
		function_gen_dropdown_date_new = strMonth & " " & strDay & " " & strYear
		...
		function_gen_dropdown_date_new = strMonth & " " & strYear
	END SELECT
