<%
FUNCTION function_error_check_golf()
	...
	'### SET QUERY STRING ###
	strQuery = strQueryoption & "&" & strQueryPeople
	...
	'### SET REDIRECT PATH ###
	strRedirectPath = "/"& function_generate_golf_link(arrProduct(2,0),"",1)& "/"& arrProduct(3,0) & "?" & strQuery
	'### SET REDIRECT PATH ###	
	...
	function_error_check_golf = strAllOption
