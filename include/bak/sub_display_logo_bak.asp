	...
	SELECT CASE intType
		...
		Case 1 '### Home Page ###
			...
			IF NOT bolPartnerLogo Then
				...
				strLogo = strLogo &  "<img src=""/images/banner_ht2th.jpg""><br />" & VbCrlf
			...
			Else
				...
				strLogo = strLogo & "<td align=""left"" valign=""bottom""><a href=""/"" title=""Hotels2Thailand.com Home""><img src=""/images/small_logo_aff.gif"" border=""0"" /></a></td>" &VbCrlf
				strLogo = strLogo & "<td align=""right"" valign=""bottom""><img src=""/"&arrLogo(3,0)&""" border=""0"" /></td>" &VbCrlf
				strLogo = strLogo & "</tr>" &VbCrlf
		...
		Case 2 '### Hotel Detail ###
			...
			Else
				...
				strLogo = strLogo & "<td align=""right""><img src=""/"&arrLogo(3,0)&""" border=""0"" /></td>" & VbCrlf
				strLogo = strLogo & "</tr>" & VbCrlf
				strLogo = strLogo & "</table>" & VbCrlf
				strLogo = strLogo & "</td>" & VbCrlf
				strLogo = strLogo & "</tr>" & VbCrlf
