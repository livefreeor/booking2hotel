...
Dim rsGateway
	...
	<td><img src="/images/img_creditcard_visa.gif" alt="Visa Card">&nbsp;&nbsp;<img src="/images/img_creditcard_master.gif" alt="Master Card"></td>
	</tr>
    <tr>
	<td align="left" valign="top"><input type="radio" name="payBank" value="5" /></td>
	<td><img src="/images/img_jcb.gif" alt="JCB"> </td>
    </tr>
    <tr>
    <td colspan="2"><br /><input type="image" src="/images/b_make_payment.gif" width="112" height="26" name="cmdkbank" value="1"></td>
	</tr>
	<%
    ...
    <td>
	<img src="/images/img_creditcard_visa.gif" alt="Visa Card">&nbsp;&nbsp;<img src="/images/img_creditcard_master.gif" alt="Master Card">&nbsp;&nbsp;<img src="/images/img_jcb.gif" alt="JCB">
    </td>
    </tr>
    <tr>
    <td colspan="2"><br /><input type="image" src="/images/b_make_payment.gif" width="112" height="26" name="cmdkbank" value="1"></td>
    ...
    <%
	Case 5 'BBL mail order
	%>
	<tr>
	<td align="left" valign="top"><input type="radio" name="payBank" value="6" checked="checked"/></td>
    <td>
	<img src="/images/img_creditcard_visa.gif" alt="Visa Card">&nbsp;&nbsp;<img src="/images/img_creditcard_master.gif" alt="Master Card">&nbsp;&nbsp;<img src="/images/img_jcb.gif" alt="JCB">
    </td>
    </tr>
