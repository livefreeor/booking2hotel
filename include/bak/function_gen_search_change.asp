					...
					<input type="hidden" name="page" value="1">
                      ...
                      <tr> 
                        <td bgcolor="#FFFFFF" class="s"> 
                          <div align="left"><%=function_list_box_selected("destination_id | title_en ","tbl_destination where destination_id NOT IN (56,64,59)" , "title_en" , "","destination","OnChange=""ChgCate(this.options[this.selectedIndex].value)""",intDestination)%></div>
                        </td>
                      </tr>
                      <tr> 
