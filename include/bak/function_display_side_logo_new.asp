<%
FUNCTION function_display_side_logo_new(intType)
...
<table width="600" align="center">	
	<tr>
    	<td align="center">	
         <img src="images/cer/master&visa.jpg" />
        </td>
        <td align="center">	
         <img src="images/cer/verifiedvisa.jpg"  title="Verified By Visa"/>
        </td>
        <td align="center">	
        <img src="images/cer/jcb.jpg"  />
        </td>
         <td align="center">
         <img src="images/cer/verisign.jpg" />	
        </td>
         <td align="center">
         <a href="javascript:popup('http://www.dbd.go.th/edirectory/paper/?id=0105546113072&st=1',600,500)"><img src="images/cer/registered.jpg" title="This Web Site is registered with the Department of Business Development, 
the Ministry of Commerce of Thailand"  border="0"/></a>		
        </td>
        <td align="center">
         <img src="images/cer/ttt.jpg" title="TAT(Tourism Authority of Thailand)" />		
        </td>
    </tr>
</table>
<%
