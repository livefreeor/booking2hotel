<%
FUNCTION function_display_health_check_up_popular(intDestinationID,intType)
	...
	SELECT CASE intType
		Case 1 'Thailand day Trips Page
			...
			sqlPop = sqlPop & " WHERE destination_id="&intDestinationID&" AND product_cat_id=39 AND status=1"
			...
			IF bolPop Then
				...
				For intCountPop=0 To Ubound(arrPop,2)
					strReturn = strReturn & "<td width="""&intWidth&"%"" align=""center"" bgcolor=""#FFFFFF"">" & VbCrlf
					strReturn = strReturn & "<a href=""/"&function_generate_health_check_up_link(intDestinationID,"",1)&"/"&arrPop(2,intCountPop)&"""> <img src=""thailand-health-pic/"&arrPop(4,intCountPop)&"_b_1.jpg"" width=""50"" height=""55"" border=""0""><br />" & VbCrlf
	...
	function_display_health_check_up_popular = strReturn
