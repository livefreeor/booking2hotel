<%
FUNCTION function_mail_send_cdo2(strMailServer,intMailPort,strMailFrom,strMailTo,strMailUser,strMailPassword,strSubject,strBody,bolPassword,intMailType)
