<%
FUNCTION function_display_logo(intSiteID,strH1,strAltLogo,intType)
	...
	SELECT CASE intType
		...
		Case 11 '###Express Check Out ###
			...
			Else
				...
				strLogo = strLogo & "<tr>" &VbCrlf
				strLogo = strLogo & "<td align=""left"" valign=""top""><img src=""/"&arrLogo(3,0)&""" border=""0"" /></td>" &VbCrlf
				strLogo = strLogo & "<td align=""right"" valign=""top""><img src=""/images/small_logo_aff.gif"" border=""0"" /></td>" &VbCrlf
				strLogo = strLogo & "</tr>" &VbCrlf
				strLogo = strLogo & "</table>" &VbCrlf
			End IF
		Case 12
