<%
FUNCTION function_error_check_show_event()
	...
	'### SET REDIRECT PATH ###
	strRedirectPath = "/"& function_generate_show_event_link(arrProduct(2,0),"",1)& "/"& arrProduct(3,0) & "?" & strQueryFull
	'### SET REDIRECT PATH ###
	'### Check Outing ###
	...
	function_error_check_show_event = Request("option_id")
