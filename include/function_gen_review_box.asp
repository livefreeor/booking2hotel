<%
FUNCTION function_gen_review_box(intProductID,intType)
	...
	sqlReview = sqlReview & " FROM tbl_product_review "
...
%>
	<table width="100%" cellpadding="2"  cellspacing="1" bgcolor="#F4F4F4">
		...
		<tr>
			<td align="center" bgcolor="#FFFFF9"><a href="/review.asp?id=<%=intProductID%>">view <%=arrReview(0,0)%> review(s)</a> | <a href="/review_write.asp?id=<%=intProductID%>">Write Review </a></td>
		</tr>
	</table>
<%
	Else
%>
	<table width="100%" cellpadding="2"  cellspacing="1" bgcolor="#F4F4F4">
		...
		<tr>
			<td align="center" bgcolor="#FFFFF9"><a href="/review_write.asp?id=<%=intProductID%>">Write Review </a></td>
		</tr>
	</table>
<%
	End IF
...
%>
	<table width="100%" cellpadding="2"  cellspacing="1" bgcolor="#F4F4F4">
		<tr>
			<td align="left" bgcolor="#FFFFF9"><font color="#990000">Average user rating: </font>Not yet rated | <a href="/review_write.asp?id=<%=intProductID%>">Write Review </a>
</td>
		</tr>
	</table>
<%
	End IF
	Case 3 'Don't show not yet rated
	IF bolReview Then
%>
	<table width="100%" cellpadding="2"  cellspacing="1" bgcolor="#F4F4F4">
		<tr>
