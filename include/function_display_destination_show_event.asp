<%
FUNCTION function_display_destination_show_event(intDestinationID,strAnchor,intType)
	...
	sqlActivity = sqlActivity & " WHERE p.destination_id=d.destination_id AND p.status=1 AND p.destination_id="&intDestinationID&" AND p.product_cat_id IN (38)"
	...
	strReturn = strReturn & "<td><strong><font color=""#00589F"" class=""l1""> All Shows & Events in "&arrActivity(4,0)&"</font></strong></td>" & VbCrlf
	strReturn = strReturn & "</tr>" & VbCrlf
	strReturn = strReturn & "<tr>" & VbCrlf
	...
	function_display_destination_show_event = strReturn
