<%
FUNCTION function_display_destination_day_trip(intDestinationID,strAnchor,intType)
	...
	sqlActivity = sqlActivity & " WHERE p.destination_id=d.destination_id AND p.status=1 AND p.destination_id="&intDestinationID&" AND p.product_cat_id IN (34)"
	...
	function_display_destination_day_trip = strReturn
