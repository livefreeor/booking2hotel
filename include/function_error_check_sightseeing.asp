<%
FUNCTION function_error_check_sightseeing()
	...
	'### SET REDIRECT PATH ###
	strRedirectPath = "/"& function_generate_sightseeing_link(arrProduct(2,0),"",1)& "/"& arrProduct(3,0) & "?" & strQueryFull
	'### SET REDIRECT PATH ###
	'### Check Outing ###
	...
	function_error_check_sightseeing = Request("option_id")
