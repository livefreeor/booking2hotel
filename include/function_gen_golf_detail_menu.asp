<%
FUNCTION function_gen_golf_detail_menu(intDestination,strDestination,strHotelName,strFileName,intType)
...
<table width="700" border="0" cellpadding="0" cellspacing="0">
  ...
  <tr>
    <td width="135" align="center" background="/images/bg_orange.gif"><a href="./<%=strFileNameInfo%>#info" title="<%=strHotelName%> Information"><font color="#fe5400"><b>Golf Course Info </b></font></a><a href="forum/Davis-Bangkok-Hotel_information.asp#info" title="<%=strHotelName%> Information"></a></td>
    ...
    <td width="10" height="24"><img src="/images/orange_orange.gif" width="10" height="24" /></td>
    <td width="135" align="center" background="/images/bg_orange.gif"><a href="./<%=strFileNameReview%>#review" title="<%=strHotelName%> Reviews"><font color="#fe5400"><b>Golfer Reviews</b></font></a></td>
  ...
  <tr>
    <td align="center"><table width="700" border="0" cellpadding="0" cellspacing="0">
      <tr>
        ...
        <td width="135" rowspan="2" align="center" background="/images/bg_blue.gif"><div align="center"><a href="./<%=strFileNameInfo%>#info"  title="<%=strHotelName%> Information"><b>Golf Course Info  </b></a></div></td>
...
<table width="700" border="0" cellpadding="0" cellspacing="0">
  ...
  <tr>
    ...
    <td width="135" align="center" background="/images/bg_orange.gif"><a href="./<%=strFileNameInfo%>#info"  title="<%=strHotelName%> Information"><font color="#fe5400"><b>Golf Course Info </b></font></a></td>
    <td width="135" align="center" background="/images/bg_orange.gif"><a href="./<%=strFileNameReview%>#review" title="<%=strHotelName%> Reviews"><font color="#fe5400"><b>Golfer Reviews</b></font></a></td>
    <td width="10" height="24" align="center"><img src="/images/orange_orange.gif" width="10" height="24" /></td>
    <td width="100" align="center" background="/images/bg_orange.gif"><a href="./<%=strFileNameWhy%>#why" title="Why Make Booking With Hotels2Thailand.com ?"><font color="#fe5400"><b>Why Us?</b></font></a></td>
    <td width="10" height="24" align="center"><img src="/images/orange_orange.gif" width="10" height="24" /></td>
...
<table width="700" border="0" cellpadding="0" cellspacing="0">
  <tr>
    ...
    <td width="10" height="35" rowspan="2" valign="bottom"><img src="/images/orange_blue.gif" width="12" height="35" /></td>
    <td width="135" rowspan="2" align="center" background="/images/bg_blue.gif"><div align="center"><a href="./<%=strFileNameReview%>#review"  title="<%=strHotelName%> Reviews"><b>Golfer Reviews  </b></a></div></td>
    <td width="11" height="35" rowspan="2" valign="bottom"><img src="/images/blue_orange.gif" width="11" height="35" /></td>
    <td width="83" height="11"><img src="/images/spacer_1.gif" width="5" height="11" /></td>
    <td width="5" height="11"><img src="/images/spacer_1.gif" width="5" height="11" /></td>
    <td width="99" height="11"><img src="/images/spacer_1.gif" width="5" height="11" /></td>
