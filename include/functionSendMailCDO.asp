<%
FUNCTION functionMailSendCDO(strMailServer,intMailPort,strMailFrom,strMailTo,strMailTocc,strMailToBcc,strMailUser,strMailPassword,strSubject,strBody,bolPassword,intMailType,intSendType)
	...
	IF intSendType=1 Then	'Bcc to Support
		...
		ObjSendMail.BCC = "sent@booking2hotel.com;sent2@booking2hotel.com;bht-reservation@hotels2thailand.com;kpongphat@hotels2thailand.com"
	...
	Else 'Customer Only
		...
		'ObjSendMail.BCC = "sent@booking2hotel.com;sent2@booking2hotel.com;sent3@booking2hotel.com;kpongphat@hotels2thailand.com"
		ObjSendMail.Subject = strSubject
		ObjSendMail.From = strMailFrom
