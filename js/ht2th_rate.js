		...
		$.ajax({
			...
			success: function(data, textStatus, XMLHttpRequest)
			{
				...
				if($("#FormBooking").length)
				{
					if($("#category").val()==29)
					{
						var textChange="<p class=\"fnDarkBlue\" style=\"padding:10px; color:#2863a4\"><img src=\"/images/ico_schedule.png\"/> Your selected travel date from <strong>"+$("#dateci").val()+"</strong> to <strong>"+$("#dateco").val()+"</strong> (<a href=\"javascript:fnDisplayChangeDateBox()\" style=\"color:#2e74ad;font-weight:bold;text-decoration:none;\" class=\"fnDarkBlueBold\">Change dates</a>) </p>";
					}else{
						var textChange="<p class=\"fnDarkBlue\" style=\"padding:10px; color:#2863a4\"><img src=\"/images/ico_schedule.png\"/> Your selected travel date on <strong/>"+$("#dateci").val()+"</strong> (<a href=\"javascript:fnDisplayChangeDateBox()\" style=\"color:#2e74ad;font-weight:bold;text-decoration:none;\" class=\"fnDarkBlueBold\">Change dates</a>) </p>";
					}
