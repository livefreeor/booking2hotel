$(document).ready(function () {
   ...
   jQuery("#review_block_main").append(ga);
...
function DataBindClick() {
    $("#btnReviewSubmit").click(function () {
        var ProducId = jQuery("#product").val();
        //alert(ProducId);

        var post = jQuery("#review_form_front").find("input,textarea,select,hidden").serialize();
        var ga = document.createElement('script'); ga.type = 'text/javascript';
        ...
        jQuery("#review_block_main").html(ga);
