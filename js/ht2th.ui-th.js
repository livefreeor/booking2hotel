...
arrPtype["1"][0] = "32";
arrPtype["1"][1] = "สนามกอล์ฟ";
		
arrPtype["2"] = new Array;
arrPtype["2"][0] = "34";
arrPtype["2"][1] = "ทัวร์วันเดียว";
		
arrPtype["3"] = new Array;
arrPtype["3"][0] = "36";
arrPtype["3"][1] = "กิจกรรมทางน้ำ";
		
arrPtype["4"] = new Array;
arrPtype["4"][0] = "38";
arrPtype["4"][1] = "บัตรเข้าชมการแสดง";

arrPtype["5"] = new Array;
arrPtype["5"][0] = "39";
arrPtype["5"][1] = "สถานที่ตรวจสุขภาพ";
...
function getDestinationDropDown(categoryRoot)
{
	...
	destinationList=destinationList+'<option value="0">กรุณาเลือกจังหวัด</option>';
...
function getLocationDropDown(categoryRoot,destination_id)
{
	...
	if(destination_id==0)
	{
		ddLocation=ddLocation+'<option value="-1">เลือกพี้นที่</option>';
	}else{
		ddLocation=ddLocation+'<option value="0">ทั้งหมด</option>';
	}
