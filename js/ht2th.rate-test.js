...
function SearchSubmit(frm)
{
	...
	location.href="/search_process.aspx?"+getQueryStringInit();
}
...
function DisplayRate()
	{
		...
		$.ajax({
		    ...
		    url: "/rate_new.aspx?pid=" + pid + "&cat_id=" + cat_id + "&ref1=" + refUrl + "&ref2=" + refQuery,
		    ...
		    success: function (data, textStatus, XMLHttpRequest) {
				...
				if($("#FormBooking").length)
				{
					if($("#category").val()==29)
					{
						var textChange="<p class=\"fnDarkBlue\" style=\"padding:10px; color:#2863a4\"> Your selected travel date from <strong>"+$("#dateci").val()+"</strong> to <strong>"+$("#dateco").val()+"</strong> ( <a href=\"javascript:fnDisplayChangeDateBox()\" style=\"color:#b64903;font-weight:bold;text-decoration:underline;\" class=\"fnDarkBlueBold\"><img src=\"/images/ico_schedule.png\"/> Change dates</a> ) </p>";
					}else{
						var textChange="<p class=\"fnDarkBlue\" style=\"padding:10px; color:#2863a4\"> Your selected travel date on <strong/>"+$("#dateci").val()+"</strong> ( <a href=\"javascript:fnDisplayChangeDateBox()\" style=\"color:#b64903;font-weight:bold;text-decoration:underline;\" class=\"fnDarkBlueBold\"><img src=\"/images/ico_schedule.png\"/> Change dates</a> ) </p>";
					}
					
					$(".fnDarkBlue").remove();
					$("#content_rate").prepend(textChange);
					$(".chack_rate").hide();
$(".cheapest_banner").remove();
				if($("#discount").val()>0)
				{
					$("#content_rate").prepend('<img src="/theme_color/blue/images/icon/cheapest.jpg" style="margin-left:5px;" class="cheapest_banner" />');
				}
