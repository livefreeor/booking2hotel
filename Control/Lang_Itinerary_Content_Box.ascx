<%@ Control Language="C#" AutoEventWireup="true" CodeFile="Lang_Itinerary_Content_Box.ascx.cs" Inherits="Hotels2thailand.UI.Controls.Control_Lang_Itinerary_Content_Box" %>
<%@ Register Assembly="AjaxControlToolkit" Namespace="AjaxControlToolkit" TagPrefix="ajaxToolkit" %>
    <%--<asp:UpdatePanel ID="UpdatePanel1" runat="server" UpdateMode="Conditional" >
    <ContentTemplate>--%>
 
 <div class="productcontentLangBox" style="width:98%; margin:0px 0px 0px 10px;">
  ...
  RepeatLayout="Table" SeparatorStyle-BorderWidth="0px" GridLines="None"  ItemStyle-BorderWidth="0px" ItemStyle-BorderStyle="None"
   ...
   <div class="productcontentLangBox_item_left">
        <table style="width:100%">
            <tr>
                <td><p>Title</p></td>
                <td><asp:TextBox ID="txtTitle" runat="server" Width="650px"></asp:TextBox></td>
            </tr>
            
            <tr>
               <td><p>Detail</p></td>
               <td><asp:TextBox ID="txtdetail" runat="server" TextMode="MultiLine" Width="650px" Rows="4"></asp:TextBox></td>
            </tr>
        </table>
