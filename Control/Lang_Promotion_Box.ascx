<%@ Control Language="C#" AutoEventWireup="true" CodeFile="Lang_Promotion_Box.ascx.cs" Inherits="Hotels2thailand.UI.Controls.Control_Lang_Option_Content_Box" %>
<%--<asp:UpdatePanel ID="UpdatePanel1" runat="server" UpdateMode="Conditional" >
<ContentTemplate>--%>
 <h4><asp:Image ID="imgContentIcon" runat="server" ImageUrl="~/images/content.png" /> Promotion Content Language</h4>
