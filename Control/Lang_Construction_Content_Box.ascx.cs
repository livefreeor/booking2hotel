...
{
    public partial class Control_Lang_Construction_Content_Box : System.Web.UI.UserControl
    {
        //proudct_id
        ...
        {
            if (!string.IsNullOrEmpty((this.Page as Hotels2BasePage).qConstructionId))
            {

                ArrayList item = ProductConstruction.getConStructioncontentBYIdAndLangId(int.Parse((this.Page as Hotels2BasePage).qConstructionId), (this.Page as Hotels2BasePage).CurrenStafftLangId);
        ...
        protected void btSave_Click(object sender, EventArgs e)
        {
            ...
            if (ProductConstruction.getConStructioncontentBYIdAndLangId(int.Parse((this.Page as Hotels2BasePage).qConstructionId), (this.Page as Hotels2BasePage).CurrenStafftLangId) == null)
            {

                cConstruction.InsertConStructionContent(int.Parse((this.Page as Hotels2BasePage).qConstructionId), (this.Page as Hotels2BasePage).CurrenStafftLangId, txtTitle.Text, txtdetail.Text);
            }
            else
            {

                ProductConstruction.UpdateConStructionContent(int.Parse((this.Page as Hotels2BasePage).qConstructionId), (this.Page as Hotels2BasePage).CurrenStafftLangId, txtTitle.Text, txtdetail.Text);
            }
