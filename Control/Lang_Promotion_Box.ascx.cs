...
namespace Hotels2thailand.UI.Controls
{
    public partial class Control_Lang_Option_Content_Box : System.Web.UI.UserControl
    {
        ...
        {
            if (!string.IsNullOrEmpty((this.Page as Hotels2BasePage).qPromotionId))
            {
                PromotionContent cPromoitonContent = new PromotionContent();
                cPromoitonContent = cPromoitonContent.GetPromotionContentbyProIdANdLangId(int.Parse((this.Page as Hotels2BasePage).qPromotionId), (this.Page as Hotels2BasePage).CurrenStafftLangId);
                
                if (cPromoitonContent != null)
                {
                    txtTitle.Text = cPromoitonContent.Title;
                    txtdetail.Text = cPromoitonContent.Detail;
        ...
        protected void btSave_Click(object sender, EventArgs e)
        {
            ...
            PromotionContent cPromoitonContent = new PromotionContent();
            PromotionContent.InsertOrUpdateProContent(int.Parse((this.Page as Hotels2BasePage).qPromotionId), (this.Page as Hotels2BasePage).CurrenStafftLangId, txtTitle.Text, txtdetail.Text);
