<%@ Control Language="C#" AutoEventWireup="true" CodeFile="Lang_Itinerary_title_Content_Box.ascx.cs" Inherits="Hotels2thailand.UI.Controls.Control_Lang_Itinerary_title_Content_Box" %>
