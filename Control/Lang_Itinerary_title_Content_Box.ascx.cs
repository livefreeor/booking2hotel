...
{
    public partial class Control_Lang_Itinerary_title_Content_Box : System.Web.UI.UserControl
    {
        //proudct_id
        ...
        public void BindContentLang()
        {
            ...
            ArrayList item = ProductItinerary.GetItinerarytitleByItineraryAndLangId(int.Parse((this.Page as Hotels2BasePage).qOptionId), (this.Page as Hotels2BasePage).CurrenStafftLangId);
        ...
        protected void btSave_Click(object sender, EventArgs e)
        {
            ...
            ArrayList Result = ProductItinerary.GetItinerarytitleByItineraryAndLangId(int.Parse((this.Page as Hotels2BasePage).qOptionId), (this.Page as Hotels2BasePage).CurrenStafftLangId);
            if (Result == null)
                {
                    int ItineraryId = ProductItinerary.InsertItinerary(int.Parse((this.Page as Hotels2BasePage).qOptionId), false);
                    ProductItinerary.InsertItineraryTitleContent(ItineraryId, (this.Page as Hotels2BasePage).CurrenStafftLangId, txtTitle.Text);
                }
                else
                {
                    ProductItinerary.UpdateItineraryTitleContent((int)Result[1], (this.Page as Hotels2BasePage).CurrenStafftLangId, txtTitle.Text);
                }
