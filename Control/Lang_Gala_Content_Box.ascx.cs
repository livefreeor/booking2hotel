...
{
    public partial class Control_Lang_Gala_Content_Box : System.Web.UI.UserControl
    {
        //proudct_id
        ...
        protected void btSave_Click(object sender, EventArgs e)
        {
            if (!string.IsNullOrEmpty((this.Page as Hotels2BasePage).qOptionId))
            {
                ...
                else
                {
                    ...
                    cupdating.UpdateOptionContentLang(int.Parse((this.Page as Hotels2BasePage).qOptionId), (this.Page as Hotels2BasePage).CurrenStafftLangId, txtTitle.Text, txtdetail.Text);
