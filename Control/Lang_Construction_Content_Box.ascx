<%@ Control Language="C#" AutoEventWireup="true" CodeFile="Lang_Construction_Content_Box.ascx.cs" Inherits="Hotels2thailand.UI.Controls.Control_Lang_Construction_Content_Box" %>
